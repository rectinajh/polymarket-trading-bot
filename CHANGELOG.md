...
**2026-08-26（ops）：** 四进程 PM2：`polymarket-bot` / `polymarket-btc15m` **live**；`polymarket-ops-alerts` 120s + **Discord**（`DELPHI_ALERT_WEBHOOK_URL`）。未完成项见 [`docs/ROADMAP.md#未完成--待办`](docs/ROADMAP.md#未完成--待办)。
